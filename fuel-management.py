...
# Load the model
try:
    model = joblib.load('/Users/usmanali/Uwindsor/Third/Project/trackline-solutions-web/ML-Model/fuel_mileage_model.pkl')
...
def predict():
    try:
        ...
        lower_bound = predicted_mileage - 5
        ...
        response = {
            ...
            'predicted_mileage_upper_bound': predicted_mileage + 5,
